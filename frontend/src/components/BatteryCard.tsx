...
export function BatteryCard() {
  ...
  // Sync countdown from API, then tick locally
  useEffect(() => {
  ...
  return (
    <div className={clsx(
      'bg-panel-surface border rounded-xl p-5 transition-opacity duration-500',
      'border-panel-border',
...
function CardSkeleton() {
  return (
    <div className="bg-panel-surface border border-panel-border rounded-xl p-5 animate-pulse">
      <div className="text-xs font-mono text-zinc-600 uppercase tracking-widest mb-4">Battery</div>
